...
},{"underscore":"K2RcUv"}],"jquery":[function(require,module,exports){
...
console.log('ok');
console.log(data.map(function(day) {
	return day[0].Close;
}));
	...
	dayGroup.append('circle')
		...
		.on('mouseover', function(d) {
			tooltip.transition()
				.duration(200)
				.style('opacity', .9);
			tooltip.html('<b>'+d[2]+'</b>' + '<br/>' + d[0].Symbol + ': ' + d[0].Close + '<br />' +d[1].Symbol + ': ' + d[1].Close)
...
getStocksSortedByDay({ stocks: [$('#s1').val(), $('#s2').val()], startDate: $('#d1').val(), endDate: $('#d2').val() }, 'historicaldata', function(err, data) {
	showPlot(data);
});
...
},{"./app.js":1,"./yahoo-finance-stock-data.js":3,"d3-browserify":4}],3:[function(require,module,exports){
/*
